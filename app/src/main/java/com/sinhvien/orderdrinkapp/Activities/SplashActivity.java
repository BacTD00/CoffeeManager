...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Animation sideAnim1 = AnimationUtils.loadAnimation(this,R.anim.slide_in_right);
        Animation sideAnim2 = AnimationUtils.loadAnimation(this,R.anim.sile_down);
        ...
        TXTWelcome.setAnimation(sideAnim2);
